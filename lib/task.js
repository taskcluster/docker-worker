...
Task.prototype = {
  ...
  */
  ...
  completeRun: function* (success, exceptionReason='') {
    ...
    if (exceptionReason) {
      yield this.runtime.stats.timeGen(
        ...
        queue.reportException(
          this.status.taskId, this.runId, { reason: exceptionReason }
        )
      );
      return;
    }
  ...
  */
  ...
  setRuntimeTimeout: function(maxRuntime) {
    var stats = this.runtime.stats;
    var maxRuntimeMS = maxRuntime*1000;
  ...
  */
  ...
  claimAndRun: function* () {
    ...
    yield this.completeRun(success, this.taskException);
  },
  ...
  */
  run: function* () {
    ...
    var runtimeTimeoutId = this.setRuntimeTimeout(this.task.payload.maxRunTime);
