...
export default class Task {
  ...
  */
  async dockerConfig(links) {
    ...
    let taskCapabilities = this.task.payload.capabilities || {};
    let privilegedTask = taskCapabilities.priviledged || false;
    if (privilegedTask && !this.runtime.dockerConfig.allowPrivileged) {
      throw new Error(
