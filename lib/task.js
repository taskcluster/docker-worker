...
export class Reclaimer {
  ...
  async reclaimTask() {
    ...
    try {
      ...
      // TODO: If this is not the primary claim, just mark this claim as lost
      // and don't do anything further (reclaiming or marking resolved)
...
export class Task {
  ...
  */
   ...
   *
   * @param {Integer} primaryTaskId taskId of the primary task
  ...
  async resolveSuperseded(primaryTaskId, primaryRunId, addArtifacts, reason) {
    ...
    try {
      ...
      log("while resolving superseded tasks: " + e);
    }
    // TODO: add artifact pointing backward, too
  }
